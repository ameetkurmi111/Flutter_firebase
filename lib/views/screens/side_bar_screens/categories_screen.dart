...
import 'package:flutter_web_admin/views/screens/side_bar_screens/widgets/category_widget.dart';
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Container(
                alignment: Alignment.topLeft,
                child: Text('Categories',style: TextStyle(fontWeight: FontWeight.w800,fontSize: 36),),
              ),
            ),
            CategoryWidget(),
          ],
